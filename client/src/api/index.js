...
const API = axios.create({ baseURL: 'https://server-hesotomotiv.net' });
...
export const adminGirisYap=(formData)=>axios.post('https://server-hesotomotiv.net/api/admin/signin',formData);